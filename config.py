...
PICS = (environ.get('PICS', 'https://i.ibb.co/RkFqgc30/x.jpg https://i.ibb.co/8gwQ9PYx/x.jpg')).split() # Bot Start Picture
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6317211079').split()]
BOT_USERNAME = environ.get("BOT_USERNAME", "SungFileStoreBot") # without @
